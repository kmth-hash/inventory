            ...
            <div class="card-body px-0 pb-2">
              <div class="table-responsive p-0">
                <table class="table align-items-center mb-0">
                  <thead>
                    <tr>
                      <th class="text-uppercase text-secondary text-xxs text-center font-weight-bolder opacity-7">Sl No</th>
                  ...
                  <tbody>
                    <?php
                    $i = 1;
                    foreach (retreiveItems() as $val)
                    {
                        $iname = $val['name'];
                        $iqty = $val['qty'];
                        $icat = $val['category'];
                        $itemID = $val['id'];
                        $iref = 'add.php?ID='.$itemID;
                        
                        echo <<<EOL
                    <tr>
                        <td>
                        <p class="text-xs font-weight-bold mb-0 text-center"> $i</p>
                        
                      </td>
                      <td>
                        <div class="d-flex px-2 py-1">
                          <div class="d-flex flex-column justify-content-center">
                            <h6 class="mb-0 text-md text-capitalize"> $iname </h6>
                            <p class="text-xs text-secondary mb-0">
                              <a href="#" >ID : $itemID</a>
                            </p>
                          </div>
                      ...
                      <td>
                        <p class="text-xs font-weight-bold mb-0"> $iqty $icat</p>
                        <!--<p class="text-xs text-secondary mb-0">Organization</p>-->
                      </td>                      
                      <td class="align-middle">
                        <a href="$iref" class="text-danger font-weight-bold text-xs" data-toggle="tooltip" data-original-title="Edit user">
                        Edit
                        </a>
                      </td>
                    </tr>

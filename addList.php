        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form id="addItem" data-toggle="validator">
                            <div class="row">
                                <!-- <div class="col-md-12">
                                ...
                                <div class="col-md-6">                      
                                    <div class="form-group">
                                        <label>Name *</label>
                                        <input id="itemnameID" name="itemName" type="text" class="form-control" placeholder="Enter Name" data-errors="Please Enter Name." required>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Units *</label>
                                        <select id="itemunitID" name="itemCategory" class="selectpicker form-control" data-style="py-0">
                                ...
                                <div class="col-md-12">                                    
                                    <div class="form-group">
                                        ...
                                        <input id="itemqtyID" type="text" name="itemQty" class="form-control" placeholder="Enter Quantity" required>
                                        <div class="help-block with-errors"></div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea id="itemdescID" class="form-control" name="itemDesc" rows="4"></textarea>
                                    </div>
                                </div>
                            </div>                            
